  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-[#000414] mb-6">Module 3: AI Compliance</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-[#000414] text-white p-12 rounded-3xl relative overflow-hidden shadow-2xl">
          <BookOpen className="absolute -right-10 -top-10 text-[#0057ff] opacity-30 h-64 w-64" />
        ...
        <div className="bg-[#020824] text-white p-12 rounded-3xl relative overflow-hidden shadow-2xl border border-[#12d8ff]/20">
          <Search className="absolute -right-10 -top-10 text-[#12d8ff] opacity-25 h-64 w-64" />
