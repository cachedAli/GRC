  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-[#000414] mb-6">Module 1: AI Governance</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-1 transition duration-300">
          <FileText className="text-[#0057ff] h-12 w-12 mb-6" />
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-1 transition duration-300">
          <CheckCircle className="text-[#0057ff] h-12 w-12 mb-6" />
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl hover:-translate-y-1 transition duration-300">
          <Presentation className="text-[#0057ff] h-12 w-12 mb-6" />
