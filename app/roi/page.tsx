    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
        <table className="w-full text-left">
          <thead className="bg-[#eef7ff] text-[#000414]">
            <tr>
          ...
          <tbody className="divide-y divide-slate-100 text-slate-700">
            <tr className="hover:bg-slate-50 transition">
              ...
              <td className="p-6 font-semibold text-[#0057ff]">1-2 hours (Review only)</td>
            ...
            <tr className="hover:bg-slate-50 transition">
              ...
              <td className="p-6 font-semibold text-[#0057ff]">2-3 days</td>
            ...
            <tr className="hover:bg-slate-50 transition">
              ...
              <td className="p-6 font-semibold text-[#0057ff]">Continuous / Automated</td>
            ...
            <tr className="hover:bg-slate-50 transition">
              ...
              <td className="p-6 font-semibold text-[#0057ff]">On-demand (Minutes)</td>
