...
const plannedPages: Record<string, PlannedPage> = {
  ...
  pricing: {
    eyebrow: "Pricing",
    title: "Tiered by modules and users.",
    summary:
      "Pricing scales with the modules you switch on and the number of people using them. Exact numbers are shared in a demo scoped to your frameworks.",
    scope: [
      "Module-based tiers",
      "User bands",
