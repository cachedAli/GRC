...
export type NavMenu = {
  label: string;
  href: string;
  /** Rendered width of the panel; wider menus carry two columns of links. */
  width: number;
  groups: NavGroup[];
  /** Optional dark promo panel on the right. */
...
export const NAV_MENUS: NavMenu[] = [
  {
    ...
    groups: [
      {
        label: "Explore",
        links: [
          { title: "Platform overview", desc: "One data model, fourteen modules", href: "/features", icon: NAV_ICON.layers },
          { title: "The 360° linkage model", desc: "Framework to audit, one graph", href: "/features", icon: NAV_ICON.graph },
          { title: "All 14 modules", desc: "What ships, module by module", href: "/features", icon: NAV_ICON.modules },
          { title: "ComplyChat", desc: "Ask your GRC data anything", href: "/features", icon: NAV_ICON.ask },
        ],
      },
      {
        label: "Foundations",
    ...
    feature: {
      ...
      body: "Demos are scoped to your regulators — we run the gap analysis live.",
      href: "/request-demo",
      cta: "Book a demo",
    },
  },
  {
    ...
    groups: [
      {
        label: "By capability",
        links: [
          { title: "Document management", desc: "Policy library, lifecycle, drafting", href: "/governance", icon: NAV_ICON.doc },
          { title: "Vendor risk (TPRM)", desc: "Questionnaires and monitoring", href: "/features", icon: NAV_ICON.vendors },
          { title: "Vulnerability management", desc: "Register, SLA, fix guidance", href: "/features", icon: NAV_ICON.shieldAlert },
          { title: "Evidence management", desc: "Intake, OCR, cross-framework reuse", href: "/features", icon: NAV_ICON.clip },
    ...
    feature: {
      ...
      body: "Startups, mid-market and regulated enterprises each take a different route in.",
      href: "/compliance",
      cta: "Compare by stage",
    },
  },
  {
    label: "Frameworks",
    ...
    groups: [
      {
        ...
        links: [
          { title: "ISO 27001", desc: "Information security", href: "/compliance", logo: `${LOGO}/iso.org.png` },
          { title: "SOC 2", desc: "Trust services criteria", href: "/compliance", logo: `${LOGO}/aicpa.org.png` },
          { title: "PCI DSS", desc: "Payment security", href: "/compliance", logo: `${LOGO}/pcisecuritystandards.org.png` },
          { title: "NIST CSF", desc: "Cyber framework", href: "/compliance", logo: `${LOGO}/nist.gov.png` },
          { title: "GDPR", desc: "Data protection", href: "/compliance", logo: `${LOGO}/gdpr.eu.png` },
        ],
      },
      {
        label: "Regional mandates",
        links: [
          { title: "SAMA CSF", desc: "Saudi banking cyber", href: "/compliance", logo: `${LOGO}/sama.gov.sa.png` },
          { title: "SBP ETGRMF", desc: "Pakistan banking tech", href: "/compliance", logo: `${LOGO}/sbp.org.pk.png` },
          { title: "DORA", desc: "EU operational resilience", href: "/compliance", logo: `${LOGO}/esma.europa.eu.png` },
          { title: "NIS2", desc: "EU cyber directive", href: "/compliance", logo: `${LOGO}/enisa.europa.eu.png` },
          { title: "Upload your own", desc: "AI parses any regulation", href: "/compliance", icon: NAV_ICON.upload },
        ],
      },
    ],
    footer: { label: "Browse all 25+ frameworks", href: "/compliance" },
  },
  {
    label: "Resources",
    href: "/resources",
    ...
    groups: [
      {
        label: "Learn",
        links: [
          { title: "Framework guides", desc: "Control-by-control walkthroughs", href: "/resources", icon: NAV_ICON.book },
          { title: "Articles", desc: "Evidence reuse, gap analysis, audits", href: "/resources", icon: NAV_ICON.news },
          { title: "Compliance glossary", desc: "The vocabulary, plainly defined", href: "/resources", icon: NAV_ICON.glossary },
          { title: "Documentation", desc: "Setup, APIs, integrations", href: "/resources", icon: NAV_ICON.codeDoc },
        ],
      },
    ],
  },
